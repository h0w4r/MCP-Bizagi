...
public sealed class ModelTools(WorkspaceFiles files, ServerOptions options, NativeWorkflows native, Operations operations)
{
    ...
    public CallToolResult Capabilities()
    {
        ...
        return Result(new
        {
            ...
            nativeLiveSession = new { tools = new[] { "live_read", "live_apply", "live_history", "live_checkpoint", "live_reconcile", "live_publish", "live_close" },
                ...
                closeScope = "clean_retained_checkpoint_and_pinned_editor_exit_observation_not_owner_child_cleanup",
