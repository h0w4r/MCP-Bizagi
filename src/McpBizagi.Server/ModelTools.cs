    ...
    public CallToolResult Capabilities()
    {
        ...
        return Result(new
        {
            ...
            capabilities = new[] {
                ...
                new { name = "native_data_and_activity_io", status = "experimental_native_data_properties_store_references_and_derived_activity_bindings_with_fresh_readback_not_full_io_editor_or_visual_accreditation", backend = "bizagi_worker" },
