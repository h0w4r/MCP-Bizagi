...
public sealed partial class NativeEngine
{
    ...
    public EngineReply Execute(EngineRequest request, Action<string> progress)
    {
        ...
        else
        {
            ...
            if (request.Action is "edit_save" or "mutate_save" or "convert_save" or "extract_save" or "reparent_save" or "metadata_save" or "documentation_save" or "diagrams_save" or "custom_save" or "custom_import")
            {
        ...
        if (request.Action is "metadata_read" or "metadata_save" or "xpdl_import_save" or "xpdl_export" or "exchange_read" or "extract_save" or "reparent_save") reply.Metadata = Metadata(model);
        if (request.Action is "documentation_read" or "documentation_save" or "xpdl_import_save" or "xpdl_export" or "exchange_read" or "extract_save" or "reparent_save") reply.Documentation = Documentation(model);
