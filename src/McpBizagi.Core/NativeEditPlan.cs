...
public static class NativeEditPlan
{
    ...
    public static void Validate(NativeMutation[] changes)
    {
        ...
        foreach (var c in changes)
        {
            ...
            if (c.Operation is "delete" or "reconnect" && (c.Name != null || c.Documentation != null || c.Geometry != null || c.ExpandedSize != null || c.CallTarget != null || c.ActivityProperties != null || c.ActivityLoop != null || c.FlowCondition != null || c.GatewayDirection != null || c.EventProperties != null || c.EventMode != null))
                throw new InvalidDataException("Delete/reconnect do not accept node property updates.");
            if (c.Operation == "update" && c.Name == null && c.Documentation == null && c.Geometry == null && c.CallTarget == null && c.ActivityProperties == null && c.ActivityLoop == null && c.FlowCondition == null && c.GatewayDirection == null && c.EventProperties == null) throw new InvalidDataException("An update must specify an actual property.");
