...
> Managed launch/close and independent GUI compatibility remain open.
>
...
| Live unsaved Modeler sessions | Experimental source bridge | Managed companion read/property batches, native history, working-copy checkpoints, guarded original-file publication and receipt reconciliation across MCP restart; automated launch/close remain open; [boundary](docs/live-sessions.md) |
