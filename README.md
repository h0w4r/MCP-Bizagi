...
| Automatically lay out a represented diagram | Experimental source after 0.6 | Server-calculated pools, lane/milestone membership, nested expanded bodies, native resized-host anchors, graphical group enclosures, manual labels and cross-pool routes; strict native port, archive and fresh-reader gates; unsupported surfaces reject; [contract](docs/native-diagram-layout.md) |
