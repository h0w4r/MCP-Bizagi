...
| Task to unbound call | Experimental source after 0.6 | Installed refactoring command for eight task types and nested tasks; no implicit diagram creation or target binding; explicit follow-up `CallTarget.ProcessId`; [contract](docs/native-conversions.md#task-to-an-unbound-call) |
