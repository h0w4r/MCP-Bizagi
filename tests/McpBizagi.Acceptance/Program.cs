...
try
{
    ...
    if (args.Contains("--diagram-layout-only") || args.Contains("--diagram-layout-groups-only") || args.Contains("--diagram-layout-anchors-only") || args.Contains("--diagram-layout-ports-only"))
    {
        ...
        await NativeDiagramLayoutAcceptance.Run(run, (name, input) => Call(name, input), WaitOperation, VerifyWorkerExit,
            args.Contains("--diagram-layout-groups-only"), args.Contains("--diagram-layout-anchors-only"), args.Contains("--diagram-layout-ports-only"));
