...
| Native events and boundary lifecycle | Experimental source after 0.4 | Explicit catch/throw/boundary creation, interruption, reattachment, guarded activity deletion and native clone remapping; payload editing, transaction/event subprocesses and simulation behavior remain separate; [contract](native-events.md) |
