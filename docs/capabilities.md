...
| Native data and activity I/O | Experimental source after 0.4 | Typed objects/stores, shared references, association-derived activity bindings, nested-loader adjustments and clone identity checks; not a general I/O editor or GUI accreditation; [contract](native-data.md) |
