...
| Explicit native element reparenting | Experimental source after 0.5 | Same-diagram process/subprocess collections, reference closure, optional root position and whole-archive preservation; cross-diagram migration and auto-layout remain open; [contract](native-reparenting.md) |
