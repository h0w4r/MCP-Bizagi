...
| Live open/unsaved desktop documents | Experimental; 0.7 package verified | Dedicated native editor, independent owner, synchronized property batches, native undo/redo, checkpoint/publication, clean close and recovery; not arbitrary existing-window attachment; [contract](live-sessions.md) |
