...
| Embedded-to-reusable subprocess extraction | Experimental current source | Native command at root/nested levels, preserved child identities, rich content relocation and current-user tab remapping; general reparenting, reverse inlining and scenario/action migration remain open; [contract](native-refactoring.md) |
