...
| Cross-diagram scenario parameters | Experimental source after 0.6 | Explicit correspondence, context/dependency guards, native parameter moves and level-3/4 before/after metrics; inherited execution and nonempty saved-result retirement unaccredited; [contract](native-scenario-migration.md) |
